...
def sent_mutants(bash_name):
    ...
    for machine in assigned_machines:
        ...
        for core_num in assigned_machines[machine]:
            ...
            file_name = file.name
            print('\t\t{}'.format(file))
            bash_file.write('scp {} {}:/home/yangheechan/mbfl_prerequisites/core{}/jsoncpp_template/src/lib_json/{} & \n'.format(
                file, machine, core_num, file_name
            ))
            bash_file.write('ssh {} \"mkdir -p /home/yangheechan/mbfl_prerequisites/core{}/prerequisite_data && echo {}-core{}-{} > /home/yangheechan/mbfl_prerequisites/core{}/prerequisite_data/bug_version.txt\" & \n'.format(
