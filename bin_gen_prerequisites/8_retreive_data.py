...
def retreive_data(bash_name, machinecore2bug):
    data_per_bug = main_dir / 'prerequisite_data_per_bug'
    ...
    for machine in machinecore2bug:
        for core in machinecore2bug[machine]:
            ...
            command = 'scp -r {}:/home/yangheechan/mbfl_prerequisites/{}/prerequisite_data {} & \n'.format(
                machine, core, bug_version_dir
            )
...
if __name__ == "__main__":
    ...
    retreive_data('8_retreive_data.sh', machinecore2bug)