...
def reset_mfbl(bash_name, template_name):
    ...
    for machine in machines:
        ...
        for i in range(number_of_cores):
            bash_file.write('ssh {} \"mkdir -p mbfl_prerequisites/core{}" &\n'.format(machine, i))
            cnt += 1
            if cnt%5 == 0:
                bash_file.write("sleep 1s\n")
                bash_file.write('wait\n')
        bash_file.write('scp -r {} {}:/home/yangheechan/mbfl_prerequisites/ &\n'.format(
    ...
    for machine in machines:
        # copy template
        for i in range(number_of_cores):
            bash_file.write('ssh {} \"cp -r /home/yangheechan/mbfl_prerequisites/{} /home/yangheechan/mbfl_prerequisites/core{}/{}\" &\n'.format(
                machine, template_name, i, 'jsoncpp_template'
            ))
            cnt += 1
            if cnt%5 == 0:
                bash_file.write("sleep 1s\n")
...
if __name__ == '__main__':
    reset_mfbl('3_send_template.sh', 'original_jsoncpp')