...
def run_command(bash_name, machinecore2bug, command_name):
    ...
    for machine in machinecore2bug:
        for core in machinecore2bug[machine]:
            ...
            command = 'ssh {} \"cd mbfl_dataset/bin_on_machine_mbfl_dataset && ./{} {} > {}.output.{} 2>&1\" & \n'.format(
                machine, command_name, core, command_name, core
            )
...
if __name__ == "__main__":
    ...
    run_command('8-1_run_selective_command.sh', machinecore2bug, command_name)
